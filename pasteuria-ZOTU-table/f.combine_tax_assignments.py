# Script to include the best possible taxonomic match as the assigned taxonomy
# to each of the zero radius otus (zotus) generated by unoise3.

# Import mmap.
import mmap

# Write the outfile and (important) close it again.
outhandle = ("pasteuria_taxonomy_combined.txt")
...
# WARNING: files in this list MUST be in order from highest
# stringency to lowest otherwise output will include vaguest
# possible assignments for each taxa!
...
for handle in filelist:
    ...
    for line in file:
        ...
        # Create a new ZOTU name from the ZOTU number
        # and most specific (final) Tax level.
        ...
        # If taxonomy is assigned and an otu tax assignment does not
        # already exist in the outfile...
        t = s.find(zotu + "\t")
        if tax != "Unassigned" and t == -1:
            # ...write the entry for this tax assignment to
            # the output combined tax table.
